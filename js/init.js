...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: '/css/style-compressed.css', containers: 1400, grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: '/css/style-wide-compressed.css', containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: '/css/style-normal-compressed.css', containers: 960, viewport: { scalable: false } },
			narrow:		{ range: '-980', href: '/css/style-narrow-compressed.css', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: '/css/style-narrower-compressed.css', grid: { collapse: 1 } },
			mobile:		{ range: '-736', href: '/css/style-mobile-compressed.css', containers: '100%', grid: { gutters: 15, collapse: 2 } }
		},
		// breakpoints: {
